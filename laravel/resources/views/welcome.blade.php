    ...
    <nav class="fixed top-0 w-full z-50 bg-white/90 backdrop-blur-lg border-b border-gray-200" x-data="{ mobileMenuOpen: false }">
        ...
        <div x-show="mobileMenuOpen"
            ...
            <div class="p-6 space-y-1">
                ...
                <a href="#features" @click="mobileMenuOpen = false" class="flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-gray-50 transition group">
                    <svg class="w-5 h-5 text-gray-400 group-hover:text-wall-blue transition" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="#how-it-works" @click="mobileMenuOpen = false" class="flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-gray-50 transition group">
                    <svg class="w-5 h-5 text-gray-400 group-hover:text-wall-blue transition" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="#pricing" @click="mobileMenuOpen = false" class="flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-gray-50 transition group">
                    <svg class="w-5 h-5 text-gray-400 group-hover:text-wall-blue transition" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="https://docs.agentwall.io" class="flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-gray-50 transition group">
                    <svg class="w-5 h-5 text-gray-400 group-hover:text-wall-blue transition" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"/>
                    </svg>
                    <span class="font-medium text-gray-700 group-hover:text-wall-blue transition">Documentation</span>
                </a>
    ...
    <section class="pt-28 pb-20 px-4 hero-pattern bg-white">
        <div class="max-w-7xl mx-auto">
            <div class="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                <!-- Left: Content -->
                <div>
                    <div class="inline-flex items-center px-3 sm:px-4 py-2 rounded-full bg-wall-blue/10 border border-wall-blue/20 mb-4 sm:mb-6">
                        <span class="w-2 h-2 bg-success-green rounded-full mr-2 animate-pulse"></span>
                        <span class="text-wall-blue text-xs sm:text-sm font-semibold">Now in Public Beta</span>
                    </div>
                    
                    <h1 class="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold mb-4 sm:mb-6 leading-tight text-darkest">
                    ...
                    <div class="flex flex-col sm:flex-row gap-3 sm:gap-4 mb-6 sm:mb-8">
                        <a href="#waitlist" class="gradient-bg hover:opacity-90 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-xl font-semibold text-base sm:text-lg transition transform hover:scale-[1.02] glow-blue text-center">
                            Get Early Access
                        </a>
                        <a href="#how-it-works" class="border-2 border-gray-300 hover:border-wall-blue text-dark hover:text-wall-blue px-6 sm:px-8 py-3 sm:py-4 rounded-xl font-semibold text-base sm:text-lg transition text-center">
                            See How It Works
                        </a>
                    </div>
                    
                    <!-- Trust badges -->
                    <div class="flex flex-wrap items-center gap-4 sm:gap-6 text-xs sm:text-sm text-gray-500">
                        <div class="flex items-center gap-2">
                            <svg class="w-4 h-4 sm:w-5 sm:h-5 text-success-green" fill="currentColor" viewBox="0 0 20 20">
